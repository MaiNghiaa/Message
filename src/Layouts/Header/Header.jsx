...
import { PATH_CONTACT, PATH_HOME } from '../../Routes/path';
export default function Header() {
    return (
        <header>
            <nav className=" w-full flex items-center justify-between sticky max-h-16 ">
                <div className="logo">
                    <Link to={PATH_HOME}><svg className="size-16 pl-3 sm:size-20 md:size-24 lg:size-28 xl:size-32 2xl:size-36  sm:pl-6 md:pl-8 lg:pl-10 xl:pl-12 2xl:pl-14 " viewBox="0 0 95 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div id="mobile-options" className="w-full h-auto bg-[#FB8E0B] md:hidden absolute top-full flex flex-col text-sm font-semibold">
                    <a className="w-full 	flex-grow  bg-[#FB8E0B] hover:bg-teal-500 text-center py-2" href="#">About</a>
                    {/* <a className="w-full 	flex-grow bg-[#FB8E0B] hover:bg-teal-500 text-center py-2" href="#">Demos</a> */}
                    <Link to={PATH_CONTACT} className="w-full 	flex-grow bg-[#FB8E0B] hover:bg-teal-500 text-center py-2">Demos</Link>
                    <a className="w-full 	flex-grow bg-[#FB8E0B] hover:bg-teal-500 text-center py-2" href="#">Contact</a>
                    <a className="w-full  	flex-grow bg-[#FB8E0B] hover:bg-teal-500 text-center py-2" href="#">Login</a>
                    <a className="w-full  	flex-grow bg-[#FB8E0B] hover:bg-teal-500 text-center py-2" href="#">Get Started</a>
                </div>
                <div className="w-5/6 hidden md:flex md:justify-around items-center">
                    ...
                    <div className="w-2/3 flex items-center gap-6 justify-center">
                        <a href="#" className=" text-black hover:underline py-1 text-sm  xl:text-xl 2xl:text-2xl">About</a>
                        {/* <a href="#" className=" text-black hover:underline py-1   text-sm  xl:text-xl 2xl:text-2xl">Demo</a> */}
                        <Link to={PATH_CONTACT} className="text-black hover:underline py-1   text-sm  xl:text-xl 2xl:text-2xl">Demos</Link>
