...
export default function Footer() {
    return (
        <div>
            <footer className=" w-full flex flex-col items-center shadow-md ">
                <div className="w-full flex items-center justify-between max-h-16">
                    ...
                    <div className="w-1/2 flex justify-end items-center  gap-8">
                        <p className="text-sm  xl:text-xl 2xl:text-2xl">Nguyen Vuong Binh</p>
                        <p className="text-sm  xl:text-xl 2xl:text-2xl">binhv2007@gmail.com</p>
                        <p className="text-sm  xl:text-xl 2xl:text-2xl">(+84) 986353333 </p>
                    </div>
